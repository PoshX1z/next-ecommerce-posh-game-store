  ...
  return (
    <div className="min-h-screen text-white px-6 md:px-16 py-10">
      <div className="flex flex-col md:flex-row gap-10">
        {/* Left: Game Cover */}
        <div className="relative w-72 h-[430px] rounded-lg overflow-hidden shadow-lg border border-indigo-700">
          <Image
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm text-gray-400 border-t border-gray-700 pt-4">
            ...
            <p>
              <span className="text-white">Platform:</span> {product?.platform}
            </p>
            <p>
              <span className="text-white">Delivery:</span> {product?.delivery}
            </p>
            <p>
